...
class _SabitouNavigationBarState extends State<SabitouNavigationBar> {
  ...
  /// Toggles the collapsed state of the navigation items.
  ...
  /// Updates the selected navigation item and calls the onItemTapped callback.
  ///
