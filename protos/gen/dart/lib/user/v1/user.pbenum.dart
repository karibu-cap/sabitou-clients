...
class ConnectionType extends $pb.ProtobufEnum {
  static const ConnectionType UNRECOGNIZED =
      ConnectionType._(0, _omitEnumNames ? '' : 'UNRECOGNIZED');
  static const ConnectionType EMAIL =
      ConnectionType._(1, _omitEnumNames ? '' : 'EMAIL');
  static const ConnectionType GOOGLE =
      ConnectionType._(2, _omitEnumNames ? '' : 'GOOGLE');
